...
export default class PropertyBO extends BusinessObject{
   ...
   * @param {*} isSelection - decides whether the property is a selection property or a freetext property
  ...
  /**
   * Sets whether this PropertyBO is a selection property or a freetext property
   *
